<script lang="ts">
    ...
    import {GetNoteBBProportion, GetProportion, ImageFrameType} from "./ImageFrame";

    export let imageFrameType: ImageFrameType = ImageFrameType.Polaroidv1;
    ...
    let proportion : number = GetProportion(imageFrameType);
    let noteWidth = 400;
    let noteHeight = 400;
    ...
    function recalculateDimensions(): void {
        ...
        const [Xo, Yo, Xr, Yr, R] = GetNoteBBProportion(imageFrameType);
